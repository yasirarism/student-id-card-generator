...
**🚀 Web**: [https://ahct.pages.dev/](https://ahct.pages.dev/)

**♻️ API TEMP S1**: [http://sicg.vercel.app/gen?template=1&style=3](https://sicg.vercel.app/gen?name=John%20Doe&dob=1999-05-15&template=1&style=3&opacity=0.2)
...
Youre in the Quick Start section. So you should already know how to run this project, right? 😑
